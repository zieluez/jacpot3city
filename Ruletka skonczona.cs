...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            Console.WriteLine("Podaj kwotę, za którą chcesz grać (np. 100):");
            string wejscieSaldo = Console.ReadLine();
            if (double.TryParse(wejscieSaldo, out saldo) && saldo > 0)
            {
                break;
            }
        ...
        Console.WriteLine($"Twoje początkowe saldo to: {saldo} PLN.");
        ...
        while (graTrwa)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("5 - Zakończ obstawianie i zakończ turę");
                ...
                if (wybor == 5)
                {
                    if (zaklady.Count == 0)
                    {
                        Console.WriteLine("Musisz obstawić przynajmniej jeden zakład przed zakończeniem tury.");
                        continue;
                    }
                    break;
                }
                ...
                if (wybor == 1)
                {
                    ...
                    saldo -= kwotaZakladu;
                    Console.WriteLine($"Zakład przyjęty. Twoje saldo teraz: {saldo} PLN.");
            ...
            {
                Console.WriteLine($"\nTwoje saldo po turze to: {saldo} PLN");
                Console.WriteLine("Chcesz zagrać kolejną turę? (t/n)");
                string kontynuuj = Console.ReadLine().ToLower();
                if (kontynuuj != "t" && kontynuuj != "tak")
                {
    ...
    {
        Console.WriteLine("Podaj kwotę zakładu (np. 30): ");
        ...
        if (kwotaZakladu <= 0)
        {
            Console.WriteLine("Kwota zakładu musi być większa od 0.");
            return -1;
        }
